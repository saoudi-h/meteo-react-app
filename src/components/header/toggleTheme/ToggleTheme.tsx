...
const ToggleTheme: React.FC = () => {
    ...
    return (
        <div className='toggle-theme'>
            <animated.div className='toggle-theme__switch' style={{ left: leftValue, right: rightValue, ...springs }} />
            <div className='toggle-theme__svg-box' onMouseOver={handleMouseOver} onClick={handleToggle} onMouseLeave={handleMouseLeave}>
                <SunSvg />
            </div>
            <div className='toggle-theme__svg-box' onMouseOver={handleMouseOver} onClick={handleToggle} onMouseLeave={handleMouseLeave}>
                <MoonSvg />
