...
export const weatherConditions: WeatherCondition[] = [
  // Group 2xx: Orages
  { id: 200, main: 'Orages', description: 'Orages avec pluie légère', icon: '11d' },
  { id: 201, main: 'Orages', description: 'Orages avec pluie', icon: '11d' },
  { id: 202, main: 'Orages', description: 'Orages avec fortes pluies', icon: '11d' },
  ...
  { id: 230, main: 'Orages', description: 'Orages avec bruine légère', icon: '11d' },
  { id: 231, main: 'Orages', description: 'Orages avec bruine', icon: '11d' },
  { id: 232, main: 'Orages', description: 'Orages avec fortes bruines', icon: '11d' },
  ...
  { id: 310, main: 'Bruine', description: 'Pluie légère et bruine', icon: '09d' },
  { id: 311, main: 'Bruine', description: 'Pluie et bruine', icon: '09d' },
  { id: 312, main: 'Bruine', description: 'Pluie forte et bruine', icon: '09d' },
  { id: 313, main: 'Bruine', description: 'Averses de pluie et bruine', icon: '09d' },
  { id: 314, main: 'Bruine', description: 'Averses de pluie fortes et bruine', icon: '09d' },
  ...
  { id: 520, main: 'Pluie', description: 'Pluie légère par intermittence', icon: '09d' },
  { id: 521, main: 'Pluie', description: 'Pluie intermittente', icon: '09d' },
  { id: 522, main: 'Pluie', description: 'Pluie forte par intermittence', icon: '09d' },
  { id: 531, main: 'Pluie', description: 'Pluie intermittente déchiquetée', icon: '09d' },
  ...
  { id: 612, main: 'Neige', description: 'Légères averses de grésil', icon: '13d' },
  ...
  { id: 620, main: 'Neige', description: 'Légères averses de neige', icon: '13d' },
  { id: 621, main: 'Neige', description: 'Averses de neige', icon: '13d' },
  { id: 622, main: 'Neige', description: 'Fortes averses de neige', icon: '13d' },
  ...
  { id: 731, main: 'Poussière', description: 'Tourbillons de sable/poussière', icon: '50d' },
  ...
  // Group 80x: Nuages
  { id: 801, main: 'Nuages', description: 'Quelques nuages: 11-25%', icon: '02d' },
  { id: 802, main: 'Nuages', description: 'Nuages épars: 25-50%', icon: '03d' },
  { id: 803, main: 'Nuages', description: 'Nuages fragmentés: 51-84%', icon: '04d' },
  { id: 804, main: 'Nuages', description: 'Nuages couverts: 85-100%', icon: '04d' }
]
